...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
        ...
        <div class="form-group">
       <!--  <button type="button" class="btn btn-info pull-right" onClick="a_write()">등록</button> -->
       <button type="button" class="btn btn-danger pull-right" onClick="a_cancel()">취소</button>
       <button type="button" class="btn btn-info pull-right" data-toggle="modal" data-target="#myModal" onClick="a_write()">등록</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" onclick="a_insert()">등록</button>
