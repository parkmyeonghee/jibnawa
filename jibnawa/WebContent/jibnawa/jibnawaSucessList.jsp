	...
	function bidclick(num, cost, id,comm,memnum){
		...
		dialog.push({
			...
			//body: Object.toJSON({index:this.index, item:this.item})+"에 입찰 하시겠습니까?",
					body: "숙박인원 : " + num +"명 희망입찰가 : " + cost + " 원 이름 : "+ id +"님 에 입찰 하시겠습니까?"
							+"<input type='tel' name='inputMoney' data-axbind='money' id='AXInputMoney' value='"+cost+"' class='AXInput' />원",
			buttons:[
			...
			myGrid.setConfig({
				...
				colGroup : [
				   ...
				   {key:"MEM_NAME", label:"입찰자명", width:"100", align:"center"},
                            ...
                            {key:"CHECK_IN_DATE", label:"체크인 날짜", width:"120", align:"center"},
                            {key:"AUC_END_DATE", label:"체크아웃 날짜", width:"120", align:"center"},
                            {key:"AUC_SUCCESS_DATE", label:"입찰성공 날짜", width:"120", align:"center"},
                            {key:"AUC_SUCCESS_COST", label:"낙찰성공가", width:"100", align:"center",formatter:"money"},
