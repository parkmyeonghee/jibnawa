			...
			myGrid.setConfig({
				...
				colGroup : [
				   ...
				   {key:"MEM_NAME", label:"입찰자명", width:"100", align:"center"},
                            ...
                            {key:"AUC_START_DATE", label:"체크 인 날짜", width:"120", align:"center",formatter:"date"},
                            {key:"AUC_END_DATE", label:"체크 아웃 날짜", width:"120", align:"center"},
                            {key:"A_COUNT", label:"내 입찰가", width:"100", align:"center",formatter:"money"},
				                   // '+ 150 , 150, '닉네임'
				],
